...
## Update terbaru: Animasi gelombang 2D

Versi ini menambahkan panel animasi 2D berbasis `canvas` dengan file baru `assets/js/wave-animation.js`.

Fitur animasi:
- pilih sumber animasi: observasi atau model
- kontrol play, pause, reset
- slider kecepatan playback
- label waktu dan elevasi aktif
- otomatis melakukan sampling frame agar data panjang tetap ringan di browser
